...
Komonの基本的な情報を確認するコマンドです。

### `komon --version` / `komon -v`

**バージョン表示** - インストールされているKomonのバージョンを表示します。
...
# トラブルシューティング時
komon --version
# → サポートに報告する際にバージョン情報を伝える
```

**注意**:
- v1.25.0以降で使用可能
- それ以前のバージョンでは `pip show komon` でバージョン確認
